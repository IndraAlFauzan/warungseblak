...
return [
    ...
    */
    ...
    'exceptions' => [
        'token_expired' => 'Tymon\JWTAuth\Exceptions\TokenExpiredException',
        'token_invalid' => 'Tymon\JWTAuth\Exceptions\TokenInvalidException',
        'user_not_found' => 'Tymon\JWTAuth\Exceptions\UserNotDefinedException',
    ],
